...
<div class="custom-itemView catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php echo $this->item->event->K2BeforeDisplay; ?>
	  ...
	  <!-- Item Image -->
	  <div class="catItemImageBlock custom-imageBlock">
		  <span class="catItemImage">
		    	<img class="img-responsive" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:100%; height:auto;" />
  ...
  <div class="catItemBody">
	...
	<div class="catItemReadMore">
		<a class="k2ReadMore btn-blue" href="<?php echo $this->item->link; ?>">
			Read More
		</a>
	</div>
	<?php endif; ?>    
